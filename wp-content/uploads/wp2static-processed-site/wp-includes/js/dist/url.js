 ...
 * const authority2 = getAuthority( 'https://eldhoz-sb.github.io/pedallerschoice:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://eldhoz-sb.github.io/pedallerschoice:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://eldhoz-sb.github.io/pedallerschoice:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://eldhoz-sb.github.io/pedallerschoice:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://eldhoz-sb.github.io/pedallerschoice:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'https://eldhoz-sb.github.io/pedallerschoice:8080/this/is/a/test.jpg' ); // 'test.jpg'
